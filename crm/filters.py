...
class CustomerFilter(django_filters.FilterSet):
    ...
    email = django_filters.CharFilter(field_name='name', lookup_expr='icontains')
...
class OrderFilter(django_filters.FilterSet):
    total_amount__gte = django_filters.NumberFilter(field_name='total_price', lookup_expr='gte')
    total_amount__lte = django_filters.NumberFilter(field_name='total_price', lookup_expr='lte')
